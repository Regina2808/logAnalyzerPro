...
- Et permettre une exécution automatique via Cron.
...
loganalyzer/ ├── main.py # Point d'entrée principal ├── analyser.py # Module 1 : Ingestion et analyse ├── rapport.py # Module 2 : Génération du rapport JSON ├── archiver.py # Module 3 : Archivage et nettoyage ├── logs_test/ # Fichiers de logs pour les tests │ ├── app1.log │ ├── app2.log │ └── app3.log ├── rapports/ # Dossier généré automatiquement ├── backups/ # Dossier généré automatiquement └── README.md # Documentation technique
...
Personne 1	analyser.py	Lire les fichiers .log, filtrer selon INFO/WARN/ERROR, calculer toutes les statistiques, gérer les arguments CLI avec argparse
...
Personne 3	archiver.py	Créer l’archive .tar.gz, déplacer les fichiers, supprimer les anciens rapports selon la durée
